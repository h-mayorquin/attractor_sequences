 ...
 In order to simplify the parameter search we use an artificial connectivity matrix that we build to simulate the connectivity matrix that results from a natural training process.
  ...
  \begin{center}
    \includegraphics[scale=0.15]{matrix_overlap.pdf}
  	...
  	\begin{center}
    \includegraphics[scale=0.15]{matrix_overload.pdf}
  	\end{center}
}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Excitation Inhibition Balance}{name=stability,column=0, span=1, below=connectivity}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Successful recall for a sequence with different excitation to inhibition balances.
	
	\begin{center}
    \includegraphics[scale=0.17]{download1.png}
  	\end{center}
...
Here we see a graph of how the parameter $\tau_{z}$ affects the recall capabilities for different overlaps.  
\begin{center}
...
Here we see a graph of how the parameter \textbf{extension} affects the recall capabilities for different overlaps. 
\begin{center}
