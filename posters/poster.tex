...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Connectivity I}{name=connectivity,column=0,span=1,below=sequences}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	Here we have the outgoing connectivity from a particular attractor to the rest of them. The asymmetry of the curve implies the direction of the sequence.
	
	\begin{center}
    \includegraphics[scale=0.20]{connectivity.png}
  	\end{center}
...
Due to a local transition rule in absence of noise this model can recall a sequence of arbitrary length. Moreover, it can perform within certain limitations both \textbf{sequence completion} and \textbf{sequence disambiguation}. 
  \begin{center}
    \includegraphics[scale=0.22]{matrix.png}
 \end{center}
 
 \begin{center}
	\smaller Example of AMPA connectivity matrix and a successful recall of a sequence. 
	\end{center}
  
  \begin{center}
    \includegraphics[scale=0.215]{winning.png}
  \end{center}
...
%  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Chains}{name=results,column=1,span=2,below=model,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{1em}
\begin{multicols}{2}
\begin{itemize}
...
\begin{center}
\includegraphics[scale=0.30]{complex_recall.png}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Stability across training}{name=stability,column=0,below=connectivity,above=references}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
